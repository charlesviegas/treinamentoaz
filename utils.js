    ...
    function configureKarma(config, disableCoverage) {
        ...
        if (!(disableCoverage === true)) {
            if (isPluginProject) {
                ...
                preprocessors[global.params.src + '/components/**/*.js'] = ['coverage'];
                preprocessors[global.params.src + '/extensions/**/*.js'] = ['coverage'];
                preprocessors[global.params.src + '/sandbox.js'] = ['coverage'];
            }
        }
